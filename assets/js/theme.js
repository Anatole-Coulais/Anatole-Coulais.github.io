...
//
// Local override of the gem-owned assets/js/theme.js: simplified to a plain
// two-state light/dark toggle (no "system" step), defaulting to dark for
// first-time visitors. Everything else (highlight.js, giscus, mermaid,
// plotly, vega-lite, search, calendar theming) is unchanged from upstream.
...
// Determine the expected state of the theme toggle, which can be "dark" or
// "light" (no "system" option). Default is "dark".
...
// Determine the computed theme, which is always exactly the stored setting
// now that "system" has been removed.
